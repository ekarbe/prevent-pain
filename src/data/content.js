export const bodyData = {
    "lower-back": {
      label: "Lower Back",
      description: "Common area for fatigue and tightness in runners due to core weakness or tight hip flexors.",
      causes: [
      ]
    },
    "hips": {
      label: "Hips & Glutes",
      description: "The power engine of running. Weakness here causes issues downstream (knees/ankles).",
      causes: [
      ]
    },
    "thighs": {
